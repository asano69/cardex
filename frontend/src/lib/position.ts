...
// single "position" float column (see routes/issues/CardForm.tsx and
// IssueDetail.tsx). Inserting between two existing positions is just
...
// IssueDetail's cards sort, which adds `id` as a secondary key).
